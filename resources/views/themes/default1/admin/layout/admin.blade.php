...
<head>
    <meta charset="UTF-8">
    <title>Digitaal Kantoor | Email Tester</title>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="header">{!! Lang::get('lang.emails') !!}</li>
                <li>
                    <a href="{{ url('emails') }}" id="emails">
                        <i class="fa fa-envelope-o fa-stack-1x"></i> <span>{!! Lang::get('lang.emails') !!} </span>
