    ...
    <form id="form">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-xs-2 form-group">
                            ...
                            <input type="checkbox" name="fetching_status"
                                   id="fetching_status"> {{Lang::get('lang.enable')}}
                        </div>
                        <div class="col-xs-2 form-group">
                ...
                <div class="row">
                    <div class="col-xs-3 form-group {!! $errors->has('fetching_protocol') ? 'has-error' : ''!!}"
                        ...
                        {!!Form::select('fetching_protocol',['ews'=> 'Exchange', 'imap' => 'IMAP'],null,['class' => 'form-control select', 'id' => 'fetching_protocol']) !!}
                    </div>
                    <div class="col-xs-3 form-group  {!! $errors->has('fetching_host') ? 'has-error' : ''!!}"
                    ...
                    <div class="col-xs-3 form-group {!! $errors->has('fetching_port') ? 'has-error' : ''!!}"
                    ...
                    <div class="col-xs-3 form-group {!! $errors->has('fetching_encryption') ? 'has-error' : ''!!}"
                         id="fetching_encryption_error">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <!-- Encryption -->
                    <div class="col-xs-3 form-group {!! $errors->has('sending_protocol') ? 'has-error' : ''!!}"
                    ...
                    <!-- sending hoost -->
                    <div class="col-xs-3 form-group {!! $errors->has('sending_host') ? 'has-error' : ''!!}"
                    ...
                    <!-- sending port -->
                    <div class="col-xs-3 form-group {!! $errors->has('sending_port') ? 'has-error' : ''!!}"
                    ...
                    <!-- Encryption -->
                    <div class="col-xs-3 form-group {!! $errors->has('sending_encryption') ? 'has-error' : ''!!}"
